...
/* Lcom/test/TestCompiler/IntMath;->intShiftTest(II)[I */
extern "C" JNIEXPORT jarray JNICALL
Java_com_test_TestCompiler_IntMath_intShiftTest__II(JNIEnv *env, jobject thiz, jint p3, jint p4){
jint v0;
jint v1;
jobject v2 = NULL;
jobject v3 = NULL;
...
LOGD("4:const-string \x76\x31\x2c\x20\x27\x49\x6e\x74\x4d\x61\x74\x68\x2e\x69\x6e\x74\x53\x68\x69\x66\x74\x54\x65\x73\x74\x27");
if (v3) {
LOGD("env->DeleteLocalRef(%p):v3", v3);
env->DeleteLocalRef(v3);
}
v3 = (jstring) env->NewStringUTF("\x49\x6e\x74\x4d\x61\x74\x68\x2e\x69\x6e\x74\x53\x68\x69\x66\x74\x54\x65\x73\x74");
...
v4 = 4;
LOGD("10:new-array \x76\x30\x2c\x20\x76\x30\x2c\x20\x5b\x49");
{
#define EX_HANDLE EX_UnwindBlock
if (v4 < 0) {
...
LOGD("14:shl-int \x76\x31\x2c\x20\x76\x33\x2c\x20\x76\x34");
v5 = (v0) << (v1 & 0x1f);
v6 = 0;
...
LOGD("1e:shr-int \x76\x31\x2c\x20\x76\x33\x2c\x20\x76\x34");
v5 = (v0) >> (v1 & 0x1f);
v6 = 1;
LOGD("24:aput \x76\x31\x2c\x20\x76\x30\x2c\x20\x76\x32");
{
#define EX_HANDLE EX_UnwindBlock
D2C_NOT_NULL(v2);
{jint val = v5;env->SetIntArrayRegion((jintArray) v2, (jint) v6, 1, &val);}
...
LOGD("28:ushr-int \x76\x31\x2c\x20\x76\x33\x2c\x20\x76\x34");
v5 = ((uint32_t) v0) >> (v1 & 0x1f);
v6 = 2;
LOGD("2e:aput \x76\x31\x2c\x20\x76\x30\x2c\x20\x76\x32");
{
#define EX_HANDLE EX_UnwindBlock
D2C_NOT_NULL(v2);
{jint val = v5;env->SetIntArrayRegion((jintArray) v2, (jint) v6, 1, &val);}
...
LOGD("32:shl-int \x76\x31\x2c\x20\x76\x33\x2c\x20\x76\x34");
v5 = (v0) << (v1 & 0x1f);
LOGD("36:shr-int/2addr \x76\x31\x2c\x20\x76\x34");
v5 = (v5) >> (v1 & 0x1f);
LOGD("38:ushr-int/2addr \x76\x31\x2c\x20\x76\x34");
v5 = ((uint32_t) v5) >> (v1 & 0x1f);
LOGD("3a:shl-int/2addr \x76\x31\x2c\x20\x76\x34");
v5 = (v5) << (v1 & 0x1f);
v6 = 3;
LOGD("3e:aput \x76\x31\x2c\x20\x76\x30\x2c\x20\x76\x32");
{
#define EX_HANDLE EX_UnwindBlock
D2C_NOT_NULL(v2);
{jint val = v5;env->SetIntArrayRegion((jintArray) v2, (jint) v6, 1, &val);}
