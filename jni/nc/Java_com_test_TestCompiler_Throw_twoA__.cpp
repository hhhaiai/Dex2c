...
/* Lcom/test/TestCompiler/Throw;->twoA()V */
extern "C" JNIEXPORT void JNICALL
Java_com_test_TestCompiler_Throw_twoA__(JNIEnv *env, jobject thiz){
jobject v0 = NULL;
jobject v1 = NULL;
jobject v2 = NULL;
jint v3;
...
LOGD("4:const-string \x76\x31\x2c\x20\x27\x54\x68\x72\x6f\x77\x2e\x74\x77\x6f\x41\x27");
if (v2) {
LOGD("env->DeleteLocalRef(%p):v2", v2);
env->DeleteLocalRef(v2);
}
v2 = (jstring) env->NewStringUTF("\x54\x68\x72\x6f\x77\x2e\x74\x77\x6f\x41");
...
v5 = 0;
L1:
LOGD("14:invoke-virtual \x76\x36\x2c\x20\x4c\x63\x6f\x6d\x2f\x74\x65\x73\x74\x2f\x54\x65\x73\x74\x43\x6f\x6d\x70\x69\x6c\x65\x72\x2f\x54\x68\x72\x6f\x77\x3b\x2d\x3e\x74\x68\x72\x6f\x77\x41\x72\x69\x74\x68\x6d\x65\x74\x69\x63\x45\x78\x63\x65\x70\x74\x69\x6f\x6e\x28\x29\x56");
{
#define EX_HANDLE EX_LandingPad_1
D2C_NOT_NULL(v0);
jclass &clz = cls2;
jmethodID &mid = mth1;
D2C_RESOLVE_METHOD(clz, mid, "com/test/TestCompiler/Throw", "throwArithmeticException", "()V");
jvalue args[] = {};
...
v7 = 1;
LOGD("34:if-nez \x76\x30\x2c\x20\x2b\x34");
if(v3 != 0){
goto L8;
}
else {
...
v8 = 0;
L9:
LOGD("3e:invoke-static \x76\x35\x2c\x20\x4c\x63\x6f\x6d\x2f\x74\x65\x73\x74\x2f\x54\x65\x73\x74\x43\x6f\x6d\x70\x69\x6c\x65\x72\x2f\x4d\x61\x69\x6e\x3b\x2d\x3e\x61\x73\x73\x65\x72\x74\x54\x72\x75\x65\x28\x5a\x29\x56");
{
#define EX_HANDLE EX_UnwindBlock
jclass &clz = cls3;
jmethodID &mid = mth2;
