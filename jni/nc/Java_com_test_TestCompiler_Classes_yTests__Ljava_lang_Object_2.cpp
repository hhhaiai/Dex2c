...
/* Lcom/test/TestCompiler/Classes;->yTests(Ljava/lang/Object;)V */
extern "C" JNIEXPORT void JNICALL
Java_com_test_TestCompiler_Classes_yTests__Ljava_lang_Object_2(JNIEnv *env, jobject thiz, jobject p1){
jobject v0 = NULL;
jint v1;
