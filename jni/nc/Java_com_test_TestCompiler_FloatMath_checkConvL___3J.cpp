...
/* Lcom/test/TestCompiler/FloatMath;->checkConvL([J)V */
extern "C" JNIEXPORT void JNICALL
Java_com_test_TestCompiler_FloatMath_checkConvL___3J(JNIEnv *env, jobject thiz, jarray p7){
jobject v0 = NULL;
jobject v1 = NULL;
jobject v2 = NULL;
jint v3;
...
LOGD("4:const-string \x76\x31\x2c\x20\x27\x46\x6c\x6f\x61\x74\x4d\x61\x74\x68\x2e\x63\x68\x65\x63\x6b\x43\x6f\x6e\x76\x4c\x27");
if (v2) {
LOGD("env->DeleteLocalRef(%p):v2", v2);
env->DeleteLocalRef(v2);
}
v2 = (jstring) env->NewStringUTF("\x46\x6c\x6f\x61\x74\x4d\x61\x74\x68\x2e\x63\x68\x65\x63\x6b\x43\x6f\x6e\x76\x4c");
...
v5 = 1;
v6 = -2005440939;
LOGD("1c:cmp-long \x76\x36\x2c\x20\x76\x31\x2c\x20\x76\x34");
v7 = (v4 == v6) ? 0 : (v4 > v6) ? 1 : -1;
LOGD("20:if-nez \x76\x36\x2c\x20\x2b\x34");
if(v7 != 0){
goto L2;
}
else {
...
LOGD("30:aget-wide \x76\x31\x2c\x20\x76\x37\x2c\x20\x76\x33");
{
#define EX_HANDLE EX_UnwindBlock
D2C_NOT_NULL(v0);
...
v6 = 123;
LOGD("38:cmp-long \x76\x36\x2c\x20\x76\x31\x2c\x20\x76\x34");
v7 = (v4 == v6) ? 0 : (v4 > v6) ? 1 : -1;
LOGD("3c:if-nez \x76\x36\x2c\x20\x2b\x34");
if(v7 != 0){
goto L5;
}
else {
...
v8 = 2;
LOGD("4e:aget-wide \x76\x31\x2c\x20\x76\x37\x2c\x20\x76\x31");
{
#define EX_HANDLE EX_UnwindBlock
D2C_NOT_NULL(v0);
...
v6 = -3;
LOGD("56:cmp-long \x76\x36\x2c\x20\x76\x31\x2c\x20\x76\x34");
v7 = (v4 == v6) ? 0 : (v4 > v6) ? 1 : -1;
LOGD("5a:if-nez \x76\x36\x2c\x20\x2b\x34");
if(v7 != 0){
goto L8;
}
else {
...
v8 = 3;
LOGD("6c:aget-wide \x76\x31\x2c\x20\x76\x37\x2c\x20\x76\x31");
{
#define EX_HANDLE EX_UnwindBlock
D2C_NOT_NULL(v0);
{jlong val;env->GetLongArrayRegion((jlongArray) v0, (jint) v8, 1, &val);v4 = val;}
...
LOGD("7a:cmp-long \x76\x36\x2c\x20\x76\x31\x2c\x20\x76\x34");
v7 = (v4 == v6) ? 0 : (v4 > v6) ? 1 : -1;
LOGD("7e:if-nez \x76\x36\x2c\x20\x2b\x34");
if(v7 != 0){
goto L11;
}
else {
...
v8 = 0;
L12:
LOGD("88:invoke-static \x76\x31\x2c\x20\x4c\x63\x6f\x6d\x2f\x74\x65\x73\x74\x2f\x54\x65\x73\x74\x43\x6f\x6d\x70\x69\x6c\x65\x72\x2f\x4d\x61\x69\x6e\x3b\x2d\x3e\x61\x73\x73\x65\x72\x74\x54\x72\x75\x65\x28\x5a\x29\x56");
{
#define EX_HANDLE EX_UnwindBlock
jclass &clz = cls2;
jmethodID &mid = mth1;
...
v8 = 4;
LOGD("90:aget-wide \x76\x31\x2c\x20\x76\x37\x2c\x20\x76\x31");
{
#define EX_HANDLE EX_UnwindBlock
D2C_NOT_NULL(v0);
{jlong val;env->GetLongArrayRegion((jlongArray) v0, (jint) v8, 1, &val);v4 = val;}
...
LOGD("98:cmp-long \x76\x36\x2c\x20\x76\x31\x2c\x20\x76\x34");
v7 = (v4 == v6) ? 0 : (v4 > v6) ? 1 : -1;
LOGD("9c:if-nez \x76\x36\x2c\x20\x2b\x34");
if(v7 != 0){
goto L14;
}
else {
...
v8 = 5;
LOGD("ae:aget-wide \x76\x31\x2c\x20\x76\x37\x2c\x20\x76\x31");
{
#define EX_HANDLE EX_UnwindBlock
D2C_NOT_NULL(v0);
{jlong val;env->GetLongArrayRegion((jlongArray) v0, (jint) v8, 1, &val);v4 = val;}
...
v6 = 0;
LOGD("b6:cmp-long \x76\x36\x2c\x20\x76\x31\x2c\x20\x76\x34");
v7 = (v4 == v6) ? 0 : (v4 > v6) ? 1 : -1;
LOGD("ba:if-nez \x76\x36\x2c\x20\x2b\x34");
if(v7 != 0){
goto L17;
}
else {
...
v3 = 1;
L17:
LOGD("c2:invoke-static \x76\x30\x2c\x20\x4c\x63\x6f\x6d\x2f\x74\x65\x73\x74\x2f\x54\x65\x73\x74\x43\x6f\x6d\x70\x69\x6c\x65\x72\x2f\x4d\x61\x69\x6e\x3b\x2d\x3e\x61\x73\x73\x65\x72\x74\x54\x72\x75\x65\x28\x5a\x29\x56");
{
#define EX_HANDLE EX_UnwindBlock
jclass &clz = cls2;
jmethodID &mid = mth1;
