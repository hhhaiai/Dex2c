...
/* Lcom/test/TestCompiler/IntMath;->charSubTest()V */
extern "C" JNIEXPORT void JNICALL
Java_com_test_TestCompiler_IntMath_charSubTest__(JNIEnv *env, jobject thiz){
jobject v0 = NULL;
jobject v1 = NULL;
jint v2;
jint v3;
...
LOGD("4:const-string \x76\x31\x2c\x20\x27\x49\x6e\x74\x4d\x61\x74\x68\x2e\x63\x68\x61\x72\x53\x75\x62\x54\x65\x73\x74\x27");
if (v1) {
LOGD("env->DeleteLocalRef(%p):v1", v1);
env->DeleteLocalRef(v1);
}
v1 = (jstring) env->NewStringUTF("\x49\x6e\x74\x4d\x61\x74\x68\x2e\x63\x68\x61\x72\x53\x75\x62\x54\x65\x73\x74");
...
v2 = 233;
v3 = 65535;
LOGD("18:sub-int \x76\x32\x2c\x20\x76\x30\x2c\x20\x76\x31");
v4 = (v2 - v3);
v5 = -65302;
LOGD("22:if-ne \x76\x32\x2c\x20\x76\x33\x2c\x20\x2b\x34");
if(v4 != v5) {
goto L2;
}
else {
...
v5 = 0;
L3:
LOGD("2c:invoke-static \x76\x33\x2c\x20\x4c\x63\x6f\x6d\x2f\x74\x65\x73\x74\x2f\x54\x65\x73\x74\x43\x6f\x6d\x70\x69\x6c\x65\x72\x2f\x4d\x61\x69\x6e\x3b\x2d\x3e\x61\x73\x73\x65\x72\x74\x54\x72\x75\x65\x28\x5a\x29\x56");
{
#define EX_HANDLE EX_UnwindBlock
jclass &clz = cls2;
jmethodID &mid = mth1;
