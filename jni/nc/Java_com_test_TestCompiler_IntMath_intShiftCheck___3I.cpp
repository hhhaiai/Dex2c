...
/* Lcom/test/TestCompiler/IntMath;->intShiftCheck([I)V */
extern "C" JNIEXPORT void JNICALL
Java_com_test_TestCompiler_IntMath_intShiftCheck___3I(JNIEnv *env, jobject thiz, jarray p4){
jobject v0 = NULL;
jobject v1 = NULL;
jobject v2 = NULL;
jint v3;
...
LOGD("4:const-string \x76\x31\x2c\x20\x27\x49\x6e\x74\x4d\x61\x74\x68\x2e\x69\x6e\x74\x53\x68\x69\x66\x74\x43\x68\x65\x63\x6b\x27");
if (v2) {
LOGD("env->DeleteLocalRef(%p):v2", v2);
env->DeleteLocalRef(v2);
}
v2 = (jstring) env->NewStringUTF("\x49\x6e\x74\x4d\x61\x74\x68\x2e\x69\x6e\x74\x53\x68\x69\x66\x74\x43\x68\x65\x63\x6b");
...
v4 = 2;
LOGD("48:aget \x76\x31\x2c\x20\x76\x34\x2c\x20\x76\x31");
{
#define EX_HANDLE EX_UnwindBlock
D2C_NOT_NULL(v0);
...
v6 = 16711850;
LOGD("52:if-ne \x76\x31\x2c\x20\x76\x33\x2c\x20\x2b\x34");
if(v4 != v6) {
goto L8;
}
else {
...
v4 = 0;
L9:
LOGD("5c:invoke-static \x76\x31\x2c\x20\x4c\x63\x6f\x6d\x2f\x74\x65\x73\x74\x2f\x54\x65\x73\x74\x43\x6f\x6d\x70\x69\x6c\x65\x72\x2f\x4d\x61\x69\x6e\x3b\x2d\x3e\x61\x73\x73\x65\x72\x74\x54\x72\x75\x65\x28\x5a\x29\x56");
{
#define EX_HANDLE EX_UnwindBlock
jclass &clz = cls2;
jmethodID &mid = mth1;
...
v4 = 3;
LOGD("64:aget \x76\x31\x2c\x20\x76\x34\x2c\x20\x76\x31");
{
#define EX_HANDLE EX_UnwindBlock
D2C_NOT_NULL(v0);
{jint val;env->GetIntArrayRegion((jintArray) v0, (jint) v4, 1, &val);v4 = val;}
