...
/* Lcom/test/TestCompiler/IntMath;->lit8Test(I)[I */
extern "C" JNIEXPORT jarray JNICALL
Java_com_test_TestCompiler_IntMath_lit8Test__I(JNIEnv *env, jobject thiz, jint p3){
jint v0;
jobject v1 = NULL;
jobject v2 = NULL;
jint v3;
...
LOGD("4:const-string \x76\x31\x2c\x20\x27\x49\x6e\x74\x4d\x61\x74\x68\x2e\x6c\x69\x74\x38\x54\x65\x73\x74\x27");
if (v2) {
LOGD("env->DeleteLocalRef(%p):v2", v2);
env->DeleteLocalRef(v2);
}
v2 = (jstring) env->NewStringUTF("\x49\x6e\x74\x4d\x61\x74\x68\x2e\x6c\x69\x74\x38\x54\x65\x73\x74");
...
LOGD("16:add-int/lit8 \x76\x31\x2c\x20\x76\x33\x2c\x20\x31\x30");
v4 = (v0 + 10);
v5 = 0;
...
LOGD("20:rsub-int/lit8 \x76\x31\x2c\x20\x76\x33\x2c\x20\x31\x30");
v4 = (10 - v0);
v5 = 1;
...
LOGD("2a:mul-int/lit8 \x76\x31\x2c\x20\x76\x33\x2c\x20\x31\x30");
v4 = (v0 * 10);
v5 = 2;
...
LOGD("34:div-int/lit8 \x76\x31\x2c\x20\x76\x33\x2c\x20\x31\x30");
{
#define EX_HANDLE EX_UnwindBlock
if (10 == 0) {
...
LOGD("3e:rem-int/lit8 \x76\x31\x2c\x20\x76\x33\x2c\x20\x31\x30");
{
#define EX_HANDLE EX_UnwindBlock
if (10 == 0) {
d2c_throw_exception(env, "java/lang/ArithmeticException", "divide by zero");
...
LOGD("48:and-int/lit8 \x76\x31\x2c\x20\x76\x33\x2c\x20\x31\x30");
v4 = (v0 & 10);
v5 = 5;
...
LOGD("52:or-int/lit8 \x76\x31\x2c\x20\x76\x33\x2c\x20\x2d\x31\x30");
v4 = (v0 | -10);
v5 = 6;
...
LOGD("5c:xor-int/lit8 \x76\x31\x2c\x20\x76\x33\x2c\x20\x2d\x31\x30");
v4 = (v0 ^ -10);
v5 = 7;
